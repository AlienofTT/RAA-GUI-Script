...
(function() {
	...
	$(".type-div").append('<div class="btn selection type" id="dd">Destroyer</div>');
	$(".type-div").append('<div class="btn selection type" id="cl">Cruiser</div>');
	$(".type-div").append('<div class="btn selection type" id="bb">Battleship</div>');
	...
	function getSingleData(name, server, index){
		...
		$.ajax({type:"POST",
				...
				success:function(data,status){
					...
					$(line).append($("<td></td>").append(parseInt($(td[4]).text())));
					$(line).append($("<td></td>").append(parseInt($(td[5]).text())));
					$(line).append($("<td></td>").append(parseInt($(td[6]).text())));
					$(line).append($("<td></td>").append(parseInt($(td[7]).text())));
